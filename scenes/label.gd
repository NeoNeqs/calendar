...
@onready var scroll: EventContainer = get_parent().get_parent()

var index: int

func _process(_delta: float) -> void:
	if self.global_position.y <= scroll.global_position.y:
	...
	elif self.global_position.y > scroll.global_position.y:
